...
import HomeTranslator from "~/components/HomeTranslator.vue";
...
<template>
  <div class="flex min-h-screen flex-col items-center justify-center px-4 py-8">
    <div class="grid w-full max-w-sm gap-8 lg:max-w-4xl lg:grid-cols-2 lg:items-center">
      <!-- Left: Translator (desktop only) -->
      <div class="hidden lg:block">
        <HomeTranslator />
      </div>

      <!-- Right: cards + review status + footer -->
